...
void cast_colour_spray(byte level, struct char_data *ch, char *arg, int type,
  ...
  switch (type) {
    ...
    case SPELL_TYPE_WAND:
      if (victim) spell_colour_spray(level, ch, victim, 0);
      break;
    default:
...
void cast_energy_drain(byte level, struct char_data *ch, char *arg, int type,
  ...
  switch (type) {
    ...
    case SPELL_TYPE_SCROLL:
      ...
      break;
    case SPELL_TYPE_WAND:
      if (victim) spell_energy_drain(level, ch, victim, 0);
      break;
    case SPELL_TYPE_STAFF:
      for (victim = world[ch->in_room].people; victim;
           victim = victim->next_in_room)
        if (victim != ch) spell_energy_drain(level, ch, victim, 0);
      break;
    default:
...
void cast_fireball(byte level, struct char_data *ch, char *arg, int type,
  ...
  switch (type) {
    ...
    case SPELL_TYPE_SCROLL:
      ...
      break;
    case SPELL_TYPE_WAND:
      if (victim) spell_fireball(level, ch, victim, 0);
      break;
    default:
...
void cast_lightning_bolt(byte level, struct char_data *ch, char *arg, int type,
  ...
  switch (type) {
    ...
    case SPELL_TYPE_SCROLL:
      ...
      break;
    case SPELL_TYPE_WAND:
      if (victim) spell_lightning_bolt(level, ch, victim, 0);
      break;
    default:
...
void cast_magic_missile(byte level, struct char_data *ch, char *arg, int type,
  ...
  switch (type) {
    ...
    case SPELL_TYPE_SCROLL:
      ...
      break;
    case SPELL_TYPE_WAND:
      if (victim) spell_magic_missile(level, ch, victim, 0);
      break;
    default:
